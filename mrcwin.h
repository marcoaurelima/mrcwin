...
namespace mrcwin{
     namespace prompt{
        ...
        void bufferXY(int bufferSizeX, int bufferSizeY)
        {
            HANDLE handler = GetStdHandle(STD_OUTPUT_HANDLE);
        ...
        void consolesize(int sizeX, int sizeY)
        {
        ...
        void fontcolor(int color_text, int color_background)
        {
        ...
        void fontsize(int size, int bold)
        {
    ...
    namespace virtkeyboard{
            ...
            for(size_t i=0;i<words.size();i++){
                if(words[i][0] == '/'){
                    ...
                    if(GetAsyncKeyState(VK_F9)){
                         mrcwin::prompt::fontcolor(MRCWIN_BLACK, MRCWIN_YELLOW);
                        printf("\n MRCWIN ");
                        mrcwin::prompt::fontcolor(MRCWIN_WHITE, MRCWIN_BLACK);
                        printf(" A digitacao foi cancelada.\n");
                        return;
                    }
        ...
        void typeText(std::string text = "Este é o teste de digitação padrão.", int delay=50){
            mrcwin::prompt::fontcolor(MRCWIN_BLACK, MRCWIN_GREEN_L1);
            printf("\n MRCWIN ");
            mrcwin::prompt::fontcolor(MRCWIN_WHITE, MRCWIN_BLACK);
            printf(" A digitacao comecara em instantes. Para interromper pressione F9.\n");
